...
export default function NavBar() {
    const activeStyle = "text-sm px-2 py-1 dark:hover:bg-zinc-700 hover:bg-zinc-300"
    const regularStyle = "text-sm px-2 py-1 underline dark:hover:bg-zinc-700 hover:bg-zinc-300"
